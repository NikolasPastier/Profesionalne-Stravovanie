  ...
  return (
    <div className="min-h-screen bg-background py-20 px-4">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-4xl font-display text-primary mb-8 text-center">Vytvorte svoj profil</h1>

        <div className="bg-card border-2 border-primary/20 rounded-xl p-8">
          {step === 1 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-display text-primary mb-4">Základné údaje</h2>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-display text-primary mb-4">Ciele a aktivita</h2>
              ...
              <div className="flex gap-4">
                ...
                <Button onClick={() => setStep(3)} className="w-full bg-primary hover:bg-primary/90">
                  Ďalej
                </Button>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-display text-primary mb-4">Preferencie a alergie</h2>
              ...
              <div>
                <Label htmlFor="preferences">Stravovacie preferencie (oddelené čiarkou)</Label>
                <Input
                  id="preferences"
              ...
              <div>
                <Label htmlFor="dislikes">Potraviny, ktoré nechcete (oddelené čiarkou)</Label>
                <Input
                  id="dislikes"
              ...
              <div>
                <Label htmlFor="favorite_foods">Obľúbené jedlá (oddelené čiarkou)</Label>
                <Input
                  id="favorite_foods"
              ...
              <div>
                <Label htmlFor="health_issues">Zdravotné problémy (voliteľné)</Label>
                <Textarea
                  id="health_issues"
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="VITAJ5, CYRIL5, MEGGY5 alebo MARTIN5"
                  className="border-primary/20"
                />
                <p className="text-sm text-muted-foreground mt-1">
                  Zadajte kód VITAJ5, CYRIL5, MEGGY5 alebo MARTIN5 pre získanie 5% zľavy na vašu prvú objednávku
                </p>
              </div>
