        ...
        >
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {/* Prvé dva komponenty vedľa seba */}
              ...
              {/* Tretí komponent pod nimi */}
              <div className="border border-primary/20 rounded-lg p-6 hover:scale-105 transition-transform duration-300 text-center md:col-span-2">
                <div className="flex items-center justify-center gap-3 mb-4">
