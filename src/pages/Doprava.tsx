            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="border border-primary/20 rounded-lg p-6 hover:scale-105 transition-transform duration-300 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Preferujeme platby v hotovosti, pri doručení prvej objednávky v celej sume za všetky objednané dni.
                </p>
              </div>
              ...
              <div className="border border-primary/20 rounded-lg p-6 hover:scale-105 transition-transform duration-300 text-center">
                ...
                <p className="text-sm text-muted-foreground">Každú Nedeľu - Štvrtok:</p>
              ...
              <div className="border border-primary/20 rounded-lg p-6 hover:scale-105 transition-transform duration-300 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  nedeľu večer, pre utorok - pondelok večer, pre stredu - utorok večer, pre štvrtok - stredu večer, pre
                  piatok - štvrtok večer.
                </p>
              </div>
            </div>
          </CardContent>
