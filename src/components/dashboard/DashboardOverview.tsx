  ...
  return (
    <TooltipProvider>
      <div className="w-full space-y-6 animate-fade-in">
        {/* Main Layout - Graph Left, Content Right */}
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6">
          {/* Left Column - Graph */}
          <Card className="card-premium border-border/50">
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Graf pokroku</h3>
              {getChartData().length > 0 ? (
                ...
                <div className="h-[400px] flex items-center justify-center text-white/40 border border-dashed border-white/10 rounded-2xl">
          ...
          {/* Right Column - All Metrics and Content */}
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <Card className="card-premium border-border/50">
                <CardContent className="p-4 text-center space-y-1">
                  <div className="text-2xl font-bold text-white">{getCurrentWeight().toFixed(1)} kg</div>
              ...
              <Card className="card-premium border-border/50">
                <CardContent className="p-4 text-center space-y-1">
                  ...
                  <div className="text-xs text-white/60">Cieľová váha</div>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Card className="bg-muted/30 border-border/30">
                  <CardContent className="p-4 text-center space-y-1">
                    ...
                    <div className="text-xl font-bold text-white">{Math.round(bmr)}</div>
                ...
                <Card className="bg-muted/30 border-border/30">
                  <CardContent className="p-4 text-center space-y-1">
                    ...
                    <div className="text-xl font-bold text-white">{targetCalories}</div>
                    <div className="text-xs text-white/40">kcal/deň</div>
                  </CardContent>
                </Card>
            ...
            <Card className="card-premium border-border/50">
              <CardContent className="p-4 text-center">
                <div className="text-3xl font-bold text-white mb-1">{getRecommendedMenuSize()}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="card-premium border-border/50">
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Tipy na úspech</h3>
